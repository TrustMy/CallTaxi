package com.trust.shengyu.rentalcarclient.tools.gdgps.overlay;
...
public class BusLineOverlay {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        startBit = BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher);
        return startBit;
    }

    protected BitmapDescriptor getEndBitmapDescriptor() {
        endBit = BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher);
        return endBit;
    }

    protected BitmapDescriptor getBusBitmapDescriptor() {
        busBit = BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher);
        return busBit;
    }
