...
import com.trust.shengyu.rentalcarclient.activitys.orderhistory.OrderHistoryActivity;
import com.trust.shengyu.rentalcarclient.activitys.orderstatus.OrderStatusActivity;
import com.trust.shengyu.rentalcarclient.activitys.selectend.SelectEndActivity;
...
import com.trust.shengyu.rentalcarclient.tools.gdgps.routeplan.RoutePlan;
import com.trust.shengyu.rentalcarclient.tools.interfaces.LocationInterface;
...
//                startActivity(new Intent(context,OrderStatusActivity.class));
    ...
    public void testclear(View v){
        //清除  车辆规划的 痕迹
        routePlan.drivingRouteOverlay.removeFromMap();
    }
}
